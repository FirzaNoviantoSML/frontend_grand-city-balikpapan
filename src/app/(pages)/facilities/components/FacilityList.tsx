            ...
            >
              {
                ...
                <div>
                  ...
                  width={500}
                  height={200}
                  className="rounded-2xl w-[80vw] h-[150] object-cover"/>
                </div>
                <div className="flex items-center">
                    ...
                    <p className="w-12 border-b-2 border-orange-500 pb-2 mb-2">
                         ...
                         <div >
                {
                  ...
                  <div className="flex items-center h-[250px] ">
                    ...
                    <p className="w-12 border-b-4 border-orange-500 pb-4 mb-2">
              ...
              <div>
                {
                  ...
                  width={500}
                  height={200}
                  className="rounded-2xl w-[450] h-[250]"/>
                  :
                  <div className="flex items-center h-[250px] ">
                    <div>
